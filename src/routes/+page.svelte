<script>
  ...
  // if you look below, you can see the exact moment i started...
  // my comments were healthy, well thought out, and meainingful
  // but now? lol
  let product_list = [];
  for (let i = 0; i < data.product_listing.length; ++i) {
    if (form && form.query != "") {
      ...
      if (isNaN(form.query)) {
        if (
          data.product_listing[i].description
            .toLowerCase()
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img
        ...
        height="650px"
        src="https://hips.hearstapps.com/hmg-prod/images/2025-porsche-911-spied-front-658200b0a3a5d.jpg"
        class="d-block"
        alt="..."
      />
    </div>
    <div class="carousel-item">
      <img
        style="object-fit: cover; width: 100%"
        height="650px"
        src="https://hips.hearstapps.com/hmg-prod/images/2022-ford-mustang-shelby-gt500-02-1636734552.jpg"
        class="d-block"
        alt="..."
      />
    </div>
    <div class="carousel-item">
      <img
        style="object-fit: cover; width: 100%"
        height="650px"
        src="https://upload.wikimedia.org/wikipedia/commons/3/3d/2018-Chevrolet-Camaro-ZL1-1LE-001-01.jpg"
        class="d-block"
        alt="..."
      />
    </div>
...
<div class="container-md">
  <div
    class="container-fluid bg-white mt-3 mb-3"
    style="border-radius: 12px; padding-top: 10px; padding-bottom: 10px"
  >
    <nav>
      <ul class="pagination">
        {#if current_page == 0}
            ...
            <div class="card-body">
              <h5 class="card-title">
                <a
                  ...
                  >{helpers.to_pretty(product.description)}</a
                >
              </h5>
              <p>
                <strong>Product Weight:</strong>
                {product.weight} lbs.<br />
